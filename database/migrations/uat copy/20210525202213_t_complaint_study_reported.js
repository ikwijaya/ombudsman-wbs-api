...
exports.up = function (knex, Promise) {
  return knex.schema.createTable('t_complaint_study_reported', function (table) {
    table.increments('idx_t_complaint_study_reported');
...
exports.down = function (knex, Promise) {
  return knex.schema.dropTable('t_complaint_study_reported');
};
