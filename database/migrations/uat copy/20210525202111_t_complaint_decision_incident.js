...
exports.up = function (knex, Promise) {
  return knex.schema.createTable('t_complaint_decision_incident', function (table) {
    table.increments('idx_t_complaint_decision_incident');
    table.integer('idx_t_complaint_decision');
...
exports.down = function (knex, Promise) {
  return knex.schema.dropTable('t_complaint_decision_incident');
};
