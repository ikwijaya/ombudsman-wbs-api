...
exports.up = function (knex, Promise) {
  return knex.schema.createTable('m_city', function (table) {
    table.increments('idx_m_city');
    table.integer('idx_m_region').notNullable();
...
exports.down = function (knex, Promise) {
  return knex.schema.dropTable('m_city');
};
